...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Udaya Sree} \\ \vspace{5pt}
    \small \faPhone* \texttt{07907450091} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{udayasmv@gmail.com} \hspace{1pt} $|$ 
    \hspace{1pt} \faYoutube \hspace{2pt} \texttt{harshibar} \hspace{1pt} $|$
    \hspace{1pt} \faMapMarker* \hspace{2pt}\texttt{Reading, UK}
    \\ \vspace{-3pt}
\end{center}
